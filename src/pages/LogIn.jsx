            ...
            <div className="flex flex-col items-center justify-center h-full p-4 relative z-10">
                ...
                <form className="bg-white p-8 rounded-2xl shadow-lg w-96" onSubmit={handleFormSubmit}>
                    <div className="relative mb-10 mt-6">
                        ...
                        <div
                            className={`w-full mt-4 transition-all duration-300 ${isFocused.username ? 'border-red-500' : 'border-gray-300'}`}
                            style={{ borderBottomWidth: '2px' }} ></div>
                    ...
                    <div className="relative mb-2 mt-6">
                        ...
                        <div
                            className={` w-full  mt-4 transition-all duration-300 ${isFocused.password ? 'border-red-500' : 'border-gray-300'}`}
